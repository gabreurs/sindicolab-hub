import coverChecklist from "@/assets/portal/portal-cover-1.jpg.asset.json";
import coverLaw from "@/assets/portal/portal-cover-2.jpg.asset.json";
import coverEnergy from "@/assets/portal/portal-cover-3.jpg.asset.json";
import coverNeighbors from "@/assets/portal/portal-cover-4.jpg.asset.json";
import coverMarket from "@/assets/portal/portal-cover-5.jpg.asset.json";
...
export const portalPosts: PortalPost[] = [
  post({
    ...
    cover_image: coverLaw.url, coverAlt: "Edifícios residenciais vistos de baixo", category_id: "pcat-direito", author_id: "pa-ricardo-freitas", categorySlug: "direito", authorSlug: "ricardo-freitas", featured: true, published: true, published_at: "2026-08-10T17:21:58.000Z", view_count: 2450,
  }),
  post({
    ...
    cover_image: coverMarket.url, coverAlt: "Análise de indicadores financeiros", category_id: "pcat-mercado", author_id: "pa-camila-santos", categorySlug: "mercado", authorSlug: "camila-santos", featured: false, published: true, published_at: "2026-08-09T17:21:58.000Z", view_count: 1830,
  }),
  post({
    ...
    cover_image: coverChecklist.url, coverAlt: "Profissional revisando um plano de manutenção", category_id: "pcat-manutencao", author_id: "pa-juliana-duarte", categorySlug: "manutencao", authorSlug: "juliana-duarte", featured: false, published: true, published_at: "2026-08-08T17:21:58.000Z", view_count: 1520,
  }),
  post({
    ...
    cover_image: coverNeighbors.url, coverAlt: "Moradores reunidos em um ambiente de convivência", category_id: "pcat-moradores", author_id: "pa-camila-santos", categorySlug: "moradores", authorSlug: "camila-santos", featured: false, published: true, published_at: "2026-08-07T17:21:58.000Z", view_count: 980,
  }),
  post({
    ...
    cover_image: coverChecklist.url, coverAlt: "Checklist de gestão sobre uma mesa", category_id: "pcat-sindicos", author_id: "pa-juliana-duarte", categorySlug: "sindicos", authorSlug: "juliana-duarte", featured: false, published: true, published_at: "2026-08-06T17:21:58.000Z", view_count: 875,
  }),
  post({
    ...
    cover_image: coverEnergy.url, coverAlt: "Área comum iluminada de um condomínio", category_id: "pcat-noticias", author_id: "pa-camila-santos", categorySlug: "noticias", authorSlug: "camila-santos", featured: false, published: true, published_at: "2026-08-05T17:21:58.000Z", view_count: 720,
  }),
];
